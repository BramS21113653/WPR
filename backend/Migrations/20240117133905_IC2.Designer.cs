            ...
            modelBuilder.Entity("Research", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b804a6e8-2794-45f5-af78-a122b38f62c3"),
                            ConductorId = new Guid("fec6ef80-c060-4615-a3d3-6a3db701f0b9"),
                            DateTime = new DateTime(2024, 1, 17, 14, 39, 5, 383, DateTimeKind.Local).AddTicks(8500),
                        ...
                        new
                        {
                            Id = new Guid("26c0cb09-0913-4894-9408-939bd926bd28"),
                            ConductorId = new Guid("56402352-8019-491c-b505-b3646b7a7b39"),
                            DateTime = new DateTime(2024, 2, 17, 14, 39, 5, 383, DateTimeKind.Local).AddTicks(8620),
                        ...
                        new
                        {
                            Id = new Guid("be5f321f-553f-4393-a2b5-9c95dd7cab5d"),
                            ConductorId = new Guid("70780ade-43c0-41f6-a546-64dcb0ba2948"),
                            DateTime = new DateTime(2024, 3, 17, 14, 39, 5, 383, DateTimeKind.Local).AddTicks(8650),
            ...
            modelBuilder.Entity("BusinessUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fec6ef80-c060-4615-a3d3-6a3db701f0b9"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b03be4a7-d6a3-4444-baea-57e1e3749227",
                        ...
                        new
                        {
                            Id = new Guid("56402352-8019-491c-b505-b3646b7a7b39"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "93017130-093d-4074-be2a-3a5661580cc4",
                        ...
                        new
                        {
                            Id = new Guid("70780ade-43c0-41f6-a546-64dcb0ba2948"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b151b461-f0da-4444-b105-e77a76f18ba9",
