...
const OverOns = () => {
  return (
    <div className="main-content">
      ...
      <p>Onze experts denken graag met hen mee en bieden begeleiding op maat. Dit doen zij in nauwe samenwerking met ervaringsdeskundigen. Met onze trainingen, producten en diensten kan iedere organisatie morgen nog aan de slag met toegankelijkheid. Zo vertalen we onze kennis naar joúw praktijk.</p>
      <p>Wij denken in mogelijkheden, iedere dag opnieuw, binnen jouw doelen en budget. Zodat jouw organisatie doet waar jullie voor staan; voor collega's, klanten en/of burgers.</p>
      <p>Jouw investering in toegankelijkheid is waardevol voor jouw bedrijf én voor de samenleving. Via Stichting Accessibility vloeit jouw investering terug naar projecten die bijdragen aan een toegankelijke en inclusieve samenleving. Sluit ook bij ons aan!</p>
      <p>Wij zijn Accessibility, expert in toegankelijkheid.</p>
      <h2>Achtergrond</h2>
      <p>
      ...
      <p>Later verbreedden wij onze aandacht naar toegankelijkheid voor álle mensen met een (tijdelijke) beperking. Hierdoor zijn we sinds 2020 ook actief in de fysieke en sociale omgeving. Met onze experts werken we elke dag aan het verankeren van toegankelijkheid in organisaties in Nederland; van overheidsinstellingen tot bedrijven. Gelukkig kunnen we hierin met steeds meer partnerorganisaties optrekken. </p>
      <p>Onze beweging blijft niet onopgemerkt. De regelgeving beweegt mee: mede dankzij onze inspanningen is de internationale richtlijn op het gebied van digitale websites en apps, de WCAG(externe link), gerealiseerd. Daarnaast denken we mee met diverse richtlijnen op inclusief design en fysieke toegankelijkheid.</p>
      <p>Stichting Accessibility heeft een ANBI-status en zit in de adviescommissie van het W3C.</p>
